...
func Provider() *schema.Provider {
	p := &schema.Provider{
		ResourcesMap: map[string]*schema.Resource{
			...
			"azuredevops_branch_policy_allowed_merge_types": policy.ResourceBranchPolicyAllowedMergeTypes(),
			...
			"azuredevops_branch_policy_no_active_comments":  policy.ResourceBranchPolicyNoActiveComments(),
